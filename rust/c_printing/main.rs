fn main() {
	...
	let debug_print = ();
	println!("This will not print with normal print. Needs debug print {:?}",debug_print);
	...
	println!("{city1} is in {country} and {city2} is in {country} but {city3} is not in {country}",city1="Helsinki",city2="Oulu",city3="Tukholma",country="Suomi")
}